...
best_adaboost_fault = joblib.load('best_model_random_forest_fault.pkl')
best_adaboost_direction = joblib.load('best_model_random_forest_direction.pkl')
...
plot_confusion_matrix(y_test_direction, y_pred_test_direction, le_direction.classes_, "Confusion Matrix for Maneuvering Direction using Random Forest")
...
plot_confusion_matrix(y_test_fault, y_pred_test_fault, le_fault.classes_, "Confusion Matrix for Fault using Random Forest")
