...
save_classification_report(y_true, y_pred_classes, class_labels, "classification_report_lstm_tuning.txt")
...
plot_confusion_matrix_with_labels(
    conf_matrix,
    class_labels,
    "Confusion Matrix for LSTM - Best Model",
    save_path="confusion_matrix_lstm_tuning.png"
)

# Save the model
save_model(best_model, "lstm_best_model")

# Save the training history
plot_training_history(history, save_path="training_history_lstm_tuning.png")
