...
# Incluir o `model_type` como uma característica e codificar
le_model = LabelEncoder()
train_data.loc[:, 'model_type_encoded'] = le_model.fit_transform(train_data['model_type'])
valid_data.loc[:, 'model_type_encoded'] = le_model.transform(valid_data['model_type'])
test_data.loc[:, 'model_type_encoded'] = le_model.transform(test_data['model_type'])
