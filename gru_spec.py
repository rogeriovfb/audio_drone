...
from tensorflow.keras.layers import Input, GRU, Dense, Dropout, Reshape
...
save_classification_report(
    ...
    y_pred_fault,
    class_labels,
    save_path="classification_report_fault_gru.txt"
)
...
plot_confusion_matrix_with_labels(
    conf_matrix_fault,
    class_labels,
    "Confusion Matrix for GRU - Fault",
    save_path="confusion_matrix_fault_gru.png"
)
save_model(model, model, "gru")
# Plota os gráficos de treinamento e validação
plot_training_history(history_fault, save_path="training_history_fault_gru.png")