...
# Configuração do modelo EfficientNetB0 com camadas adicionais e Dropout
base_model_fault = EfficientNetB0(weights='imagenet', include_top=False, input_shape=(224, 224, 3))
...
checkpoint_fault = ModelCheckpoint("best_efficientnetb0_fault.keras", monitor='val_loss', save_best_only=True, mode='min')
...
save_classification_report(
    ...
    y_pred_fault,
    class_labels,
    save_path="classification_report_fault_efficientnetb0.txt"
)
...
plot_confusion_matrix_with_labels(
    conf_matrix_fault,
    class_labels,
    "Confusion Matrix for EfficientNetB0 - Fault",
    save_path="confusion_matrix_fault_efficientnetb0.png"
)

# Salvar o modelo e gráficos de treinamento
save_model(model_fault, model_fault, "efficientnetb0")
plot_training_history(history_fault, save_path="training_history_fault_efficientnetb0.png")
