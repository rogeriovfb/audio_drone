...
# Configuração do modelo VGG19 com camadas adicionais e Dropout
base_model_fault = VGG19(weights='imagenet', include_top=False, input_shape=(224, 224, 3))
...
checkpoint_fault = ModelCheckpoint("best_vgg19_fault.keras", monitor='val_loss', save_best_only=True, mode='min')
...
save_classification_report(
    ...
    y_pred_fault,
    class_labels,
    save_path="classification_report_fault_vgg19.txt"
)
...
plot_confusion_matrix_with_labels(
    conf_matrix_fault,
    class_labels,
    "Confusion Matrix for VGG19 - Fault",
    save_path="confusion_matrix_fault_vgg19.png"
)
save_model(model_fault, model_fault, "vgg19")
# Plota os gráficos de treinamento e validação
plot_training_history(history_fault, save_path="training_history_fault_vgg19.png")