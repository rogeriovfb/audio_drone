...
train_generator, valid_generator, test_generator, fault_classes = data_image_generator(data_dir, (299, 299))

# Configuração do modelo InceptionV3 com camadas adicionais e Dropout
base_model_fault = InceptionV3(weights='imagenet', include_top=False, input_shape=(299, 299, 3))
...
checkpoint_fault = ModelCheckpoint("best_inceptionv3_fault.keras", monitor='val_loss', save_best_only=True, mode='min')
...
save_classification_report(
    ...
    y_pred_fault,
    class_labels,
    save_path="classification_report_fault_inceptionv3.txt"
)
...
plot_confusion_matrix_with_labels(
    conf_matrix_fault,
    class_labels,
    "Confusion Matrix for InceptionV3 - Fault",
    save_path="confusion_matrix_fault_inceptionv3.png"
)
save_model(model_fault, model_fault, "inceptionv3")
# Plota os gráficos de treinamento e validação
plot_training_history(history_fault, save_path="training_history_fault_inceptionv3.png")